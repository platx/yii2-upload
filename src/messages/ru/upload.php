 ...
 */
return [
    'Parameter \'attributes\' is required' => 'Параметр \'attributes\' обязателен к заполнению',
    'This type of upload is not supported' => 'Этот тип загрузки не поддерживается',
    ...
    'Imagick not installed' => 'Imagick не установлен'
];